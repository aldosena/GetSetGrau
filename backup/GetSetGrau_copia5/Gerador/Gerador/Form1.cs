...
namespace Gerador
{
    public partial class Form1 : Form
    {
        ...
        private void Fu_ClasseEscola()
        {
            ...
            //select
            txEscola.Text = txEscola.Text + "  public function selectAll($es)";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  {";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  $sql = \"SELECT * FROM " + txTabela.Text + " WHERE escola = \"" + " . " + "$es;";
            txEscola.AppendText(Environment.NewLine);
            ...
            // byId
            txEscola.Text = txEscola.Text + "  public function selectById($ki)";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  {";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  $sql = \"SELECT * FROM " + txTabela.Text + " WHERE " + txIndex.Text + " = \"" + " . " +  "$ki;";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  $stmt = $this->pdo->prepare($sql);";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  $stmt->execute();";
            ...
            txEscola.Text = txEscola.Text + "    $this->Rtotal = 1;";
            txEscola.AppendText(Environment.NewLine);
            ...
            // insert  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
            txEscola.Text = txEscola.Text + "  public function insert()";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  {";
            txEscola.AppendText(Environment.NewLine);
            ...
            // update  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
            txEscola.Text = txEscola.Text + "  public function update($ki)";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  {";
            txEscola.AppendText(Environment.NewLine);
            ...
            txEscola.Text = txEscola.Text + " WHERE " + txIndex.Text + " = \"" + " . " +  "$ki;";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "    $stmt = $this->pdo->prepare($sql);";
            txEscola.AppendText(Environment.NewLine);
            foreach (string linha in txCampos.Lines)
            ...
            // delete  - - - - - -  - - - - - -  - - - - - -  - - - - - -  - - - - - -  - - - - - - 
            txEscola.Text = txEscola.Text + "  public function delete($ki)";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "  {";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "    $sql = \"DELETE FROM " + txTabela.Text + " WHERE " + txIndex.Text + " = \"" + " . " + "$ki;";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "    $stmt = $this->pdo->prepare($sql);";
            txEscola.AppendText(Environment.NewLine);
            txEscola.Text = txEscola.Text + "    $stmt->execute();";
        ...
        private void btCriar_Click(object sender, EventArgs e)
        {
            ...
            foreach (string linha in txCampos.Lines)
            {
                txFields.Text = txFields.Text + "   " + vprivate + " $" + linha + ";";
                txFields.AppendText(Environment.NewLine);
            }
            txFields.Text = txFields.Text  +  "   public $Rtotal; // linhas da tabela";
        ...
        {
            txAviso.Text = "Versao: 1.2 - 05/05/2003";
        }
        ...
        {
            txForm.Text = "";
            txForm.Text = txForm.Text + "<form name= \"fmXXX\" method=\"POST\" action=\"/api/update_processo\" target=\"_blank\">";
            txForm.AppendText(Environment.NewLine);
            foreach (object itemChecked in ListaFm. CheckedItems)
            {
                string itemText = checkedListBox1.GetItemText(itemChecked);
            }
        }
    } // class
} // name
